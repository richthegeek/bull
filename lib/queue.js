...
var Queue = function Queue(name, redisPort, redisHost, redisOptions, createClient){
  ...
  if(_.isObject(redisPort)){
    ...
    createClient = redisOpts.createClient || opts.createClient;
  }
  ...
  var getClient = function () {
    ...
    var client = createClient(redisPort, redisHost, redisOptions);
